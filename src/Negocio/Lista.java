    ...
    public void Lista(){
      ...
      public void intercambio (int pos1, int pos2){
          int Valor1 = 0, Valor2 = 0; 
            ...
            if(pos2>=0 && pos2<tamanio){
            if(pos2 == 0){
                Valor2 = inicio.getValor();
            }
            else{
                Nodo aux=inicio;
        ...
        JOptionPane.showMessageDialog(null,"El valor de la posicion "+(pos1+1)+" es: "+Valor1);
        JOptionPane.showMessageDialog(null,"El valor de la posicion "+(pos2+1)+" es: "+Valor2);
        
        if(pos1 == 0){
        inicio.setValor(Valor2);
        }else{
            Nodo auxx=inicio;
        for (int i=0; i<pos1; i++){
        auxx=auxx.getSiguiente();
        }
        auxx.setValor(Valor2);
        }
        
        if(pos2 == 0){
        inicio.setValor(Valor1);
        }else{
            Nodo auxx=inicio;
         for (int i=0; i<pos2; i++){
        auxx=auxx.getSiguiente();
        }
        auxx.setValor(Valor1);
        }
      ...
      public int cuantosRepetidos(){
         ...
         Set<Integer> ValoresSinRepetir = new HashSet<>();
         ValoresSinRepetir.addAll(Lista);
         int num1=ValoresSinRepetir.size();
         int num2=Lista.size();
         repetido=(num2-num1);
          return repetido; 
      }
      ...
      Nodo aux = inicio;
         ...
         ArrayList<Integer> ListaNum = new ArrayList<>(ValoresSinRepetir);
         ...
         tamanio=0;
            ...
            Nodo nuevo = new Nodo();
            nuevo.setValor(ListaNum.get(0));
           Nodo auxx = nuevo;
           
            for(int i =0;i<ListaNum.size();i++){
                auxx.setValor(ListaNum.get(i));
                auxx.getSiguiente();
      }      
